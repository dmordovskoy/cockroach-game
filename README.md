...
3. **Gates** — CI (lint + gdUnit4 tests), Codex review of the PR head, and the **playtest**: pull the branch on the other MacBook, F5, play, record the verdict in the PR checklist.
